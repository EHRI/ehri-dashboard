<template>
  <div>
    <div class="grid grid-cols-10 gap-1">
      <div v-if="dataSource && dataSource.component !== 'NoResults'" class="px-2 sm:px-0 col-span-10 sm:mx-0 xl:mb-2">
        <h3 class="font-sans capitalize text-ehri-dark font-thin text-3xl mt-2">{{ $t("resultsFrom",2) }} <span class="font-serif font-bold">{{ dataSourceTitle }}</span></h3>
