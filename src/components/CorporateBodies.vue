  ...
  <div :class="[filterBarClass, 'bg-ehri-purple', 'overflow-scroll', 'text-white','lg:text-ehri-dark', 'lg:col-span-2', 'col-span-12', 'lg:order-last', 'order-first', 'lg:bg-white', 'shadow-xl', 'lg:h-3/4']">
    <div :key="typeFilterKey">
      <div class="px-4 pt-4">
        ...
        :key="typeFilterKey"
        :selectedType="'EHRICorporateBodies'"
...
export default {
  ...
  setup(props, ctx){
    ...
    const facets = ref({
      ...
      desc: "A (non-exhaustive) set of corporate bodies derived from both EHRI cataloguing activities and structured data provided by EHRI partner institutions."
    })
    ...
    return { showFilterBar, filterBarClass, toggleFilterBar, CBQuery, facets, sortedTypes, typeFilterKey, handle}
  }
}
</script>
