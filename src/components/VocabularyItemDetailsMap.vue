      ...
      if (vocObject.value && long.value && lat.value) {
        ...
        if (
          ...
          leaflet
            ...
            .addTo(map.value)
            .bindPopup(getNameInLang(vocObject.value.broader[0].descriptions, lang.value));
        }
          ...
          vocObject.value.narrower.forEach((c) => {
            if (c.latitude && c.longitude) {
              leaflet
                ...
                .addTo(map.value)
                .bindPopup(getNameInLang(c.descriptions, lang.value));
            }
          });
        }
        ...
        leaflet
          ...
          .addTo(map.value)
          .bindPopup(getNameInLang(vocObject.value.descriptions, lang.value));
      }
    };

    watch([vocObject, lang], () => {
      forceRerender();
      initMap();
    });
